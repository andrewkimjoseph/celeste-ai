    ...
    return (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M12 3.75v3m0 10.5v3m8.25-8.25h-3M6.75 12h-3m11.182 5.182-2.12-2.12M9.19 8.81l-2.12-2.12m10.242 0-2.12 2.12M9.19 15.19l-2.12 2.12M12 15.25l-1.86 1.04.36-2.1-1.5-1.46 2.07-.3L12 10.5l.93 2.03 2.07.3-1.5 1.46.36 2.1L12 15.25Z"
        />
      </svg>
    );
  }
